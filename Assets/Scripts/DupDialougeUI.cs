...
public class DupDialougeUI : MonoBehaviour
{
    ...
    public static DupDialougeUI DupInstance { get; private set; }
    ...
    private void CloseDialougeBox()
    {
        ...
        UnityEngine.SceneManagement.SceneManager.LoadScene("Area2");
    }
}